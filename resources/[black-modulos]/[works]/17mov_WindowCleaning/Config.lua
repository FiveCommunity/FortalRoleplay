...
Config.Locations = {       -- Aqui você pode mudar todas as localizações principais do trabalho.
    DutyToggle = {
        Coords = {
...
Config.Price = 130            -- Means $5 per one window, so the full reward depends on current location
...
Config.Lang = {
    ...
    -- Aqui você pode mudar todas as traduções usadas no client.lua e server.lua. Não se esqueça de traduzir também no arquivo HTML e JS.

    -- Client
    ["no_permission"] = "Somente o dono da equipe pode fazer isso!",
    ["keybind"] = 'Interação com o marcador de limpeza de janela',
    ...
    ["exitPlatform"] = "Saia da plataforma",
    ["cleanWindowInfo"] = "Pressione ~INPUT_CONTEXT~ para ~y~começar~s~ a limpeza da janela",
    ["spawnpointOccupied"] = "O local de aparecimento do carro está ocupado",
    ...
    ["tutorial1"] = "O trabalho consiste em limpar as janelas de prédios residenciais. O local do seu trabalho atual foi designado. Vá até o local e comece o trabalho lá. Quando você chegar no telhado, comece a limpar as janelas. Você pode terminar o trabalho quando quiser. Seu pagamento depende de quantas janelas você limpar. Quando quiser finalizar o trabalho, retorne à base e devolva o carro da empresa. Quando terminar de limpar todas as janelas, você precisará ir até a base para pegar seu pagamento",
    ["tutorial2"] = "Você está na plataforma! Sua tarefa é limpar as janelas abaixo de você. O dono da equipe pode mover a plataforma com as setas no teclado. No topo, há um texto que permite sair da plataforma. Esta também é uma saída de emergência, caso um dos membros da equipe caia. Usando este botão, uma pessoa transporta toda a equipe para baixo. Para contar a janela como limpa, você deve limpar pelo menos 95% da superfície",
    ["partyIsFull"] = "Falha ao enviar o convite, seu grupo está cheio",
    ["inviteSent"] = "Convite enviado!",
    ["youCanControl"] = "Algo deu errado com o líder da sua equipe. A partir de agora, você pode controlar o elevador",
    ...
    -- Server
    ["isAlreadyHost"] = "Este jogador é o líder da sua equipe.",
    ...
    ["error"] = "Houve um problema ao ingressar em uma equipe. Tente novamente mais tarde.",
    ...
    ["clientsPenalty"] = "O host da equipe aceitou a punição. Você não recebeu o pagamento",
    ["emergencyStop"] = "Um membro da equipe se feriu. Nós o transportamos para baixo",
    ["tooFar"] = "Um dos jogadores se afastou demais da plataforma. Nós o movemos para baixo",
    ...
    ["someoneIsOnCooldown"] = "%s não pode começar o trabalho agora (tempo de recarga: %s)",
    ["hours"] = "h",
    ["minutes"] = "m",
    ["seconds"] = "s",

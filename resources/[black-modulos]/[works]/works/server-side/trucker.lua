...
function cRP.paymentMethod()
	...
	if user_id then
		...
		vRP.generateItem(user_id,"plasticbottle",math.random(10,30),true)
		vRP.generateItem(user_id,"glassbottle",math.random(10,30),true)
		vRP.generateItem(user_id,"elastic",math.random(10,30),true)
		vRP.generateItem(user_id,"metalcan",math.random(10,30),true)
		vRP.generateItem(user_id,"battery",math.random(10,30),true)
		vRP.generateItem(user_id,"dollars",math.random(5000,10000),true)

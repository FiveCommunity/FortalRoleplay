...
Config.Locations = {       -- Aqui você pode alterar todas as localizações base do trabalho. 
    DutyToggle = {
        Coords = {
...
Config.Clothes = {
    ...
    male = {
        ...
        ["pants"] = {clotheId = 2, variation = 3},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 13, variation = 0},
        ["t-shirt"] = {clotheId = 60, variation = 1},
        ["torso"] = {clotheId = 1, variation = 1},
        ["decals"] = {clotheId = 0, variation = 0},
        ["kevlar"] = {clotheId = 0, variation = 0},
    },

    maleHelmet = { clotheId = 146, variation = 1},
...
Config.Lang = {
    ...
    -- Aqui você pode alterar todas as traduções usadas no client.lua e server.lua. Não se esqueça de traduzi-las também no arquivo HTML e JS.

    -- Client
    ["no_permission"] = "Apenas o dono da equipe pode fazer isso!",
    ["keybind"] = 'Interação com o marcador de trabalho de construção',
    ...
    ["spawnpointOccupied"] = "O ponto de spawn do carro ou caminhão betoneira está ocupado",
    ["pipesNotReady"] = "Antes de derramar o concreto, primeiro você precisa instalar os canos",
    ["clickToPour"] = "~INPUT_CONTEXT~ para derramar concreto",
    ["installPipe"] = "Instalar cano",
    ["pickupBlock"] = "Pegar Bloco",
    ["tutorialAfterMixerPickup"] = "Você acabou de pegar a betoneira designada pelo seu chefe. Dirija até o local de construção e depois derrame o concreto nas áreas designadas. O local da obra está marcado no GPS",
    ["startingTutorial"] = "Bem-vindo ao trabalho de pedreiro. Uma variedade de tarefas aguarda você no local, desde soldagem, construção de paredes, fazendo drenagens ou derramando concreto. Se você estiver trabalhando em grupo, agora terá que se dividir, uma pessoa deve ser deixada no ponto de coleta da betoneira e depois transportar a betoneira até o local de construção. Cada atividade será explicada quando você se aproximar dela. Você tem as localizações das tarefas marcadas no mapa. Se você trabalhar sozinho, deve completar cada tarefa por conta própria, se trabalhar em grupo - você decide como quer dividir. Você não precisa fazer todas as tarefas, pode terminar quando quiser, e seu pagamento depende de quantos % das tarefas você faz. Desejamos boa sorte!",
    ["installBlock"] = "Construir uma parede",
    ["tutorialWallBuilding"] = "Você está ao lado da estrutura da parede, sua tarefa é construí-la usando blocos de concreto. Os blocos de concreto estão perto da estrutura e marcados no GPS. Vá até a pilha de blocos, pegue um e depois monte-o na parede",
    ["tutorialAboutPipes"] = "Você está ao lado de um buraco que mostra os canos de esgoto. Sua tarefa é instalar os canos nos lugares certos. Após instalar os canos, você deve derramar concreto sobre o buraco usando uma betoneira.",
    ["tutorialWelding"] = "Você está ao lado do local onde o chefe pediu para você soldar algo. O trabalho é bem simples, sem necessidade de explicações adicionais",
    ["startWelding"] = "Começar Soldagem",
    ["workstationOccupied"] = "Esta estação de trabalho está ocupada",
    ["notFullJob"] = "Você precisa fazer 100% do progresso antes de terminar um trabalho",
    ["notADriver"] = "Você precisa ser o motorista do veículo para terminar o trabalho",
    ["partyIsFull"] = "Falha ao enviar convite, sua equipe está cheia",
    ["wrongReward1"] = "O percentual de pagamento deve estar entre 0 e 100",
    ["wrongReward2"] = "O percentual total de todos os pagamentos excedeu 100%",
    ...
    ["RequireOneFriend"] = "Este trabalho exige pelo menos um membro da equipe",
    ["penalty"] = "Você pagou uma multa no valor de ",
    ["clientsPenalty"] = "O chefe da equipe aceitou a punição. Você não recebeu o pagamento",
    ["noMixerStatus"] = "Atualmente, não temos nenhuma betoneira disponível para você. Tente novamente mais tarde",
    ...
    ["minutes"] = "m",
    ["seconds"] = "s",
    ["newBoss"] = "O antigo chefe do lobby saiu do servidor. Agora você é o líder da equipe",
...
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Betoneira para coleta",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
    ...
    ["installPipe"] = {
        color = 47,
        string = "[CONSTRUTOR] Instalar cano",
        sprite = nil,
    },
    ["blockPickup"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Coletar blocos para construção de parede",
        sprite = 655, 
    },
    ["buildWall"] = {
        color = 47,
        string = "~o~[CONSTRUTOR]~s~ Construir uma parede",
        sprite = 285, 
    },

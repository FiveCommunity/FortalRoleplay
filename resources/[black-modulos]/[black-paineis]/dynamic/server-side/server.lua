		...
		["mp_f_freemode_01"] = { -- 
			...
			["11"] = {
				["mp_m_freemode_01"] = {
					...
					["torso"] = { item = 31, texture = 7 },
					["accessory"] = { item = 126, texture = 0 },
					["watch"] = { item = -1, texture = 0 },
					["arms"] = { item = 75, texture = 0 },
					["glass"] = { item = 0, texture = 0 },
					["ear"] = { item = -1, texture = 0 },
				},
				["mp_f_freemode_01"] = {
					["hat"] = { item = 57, texture = 0 },
					["pants"] = { item = 36, texture = 4 },
					["vest"] = { item = -1, texture = 0 },
					["bracelet"] = { item = -1, texture = 0 },
					["backpack"] = { item = 0, texture = 0 },
					["decals"] = { item = 0, texture = 0 },
					["mask"] = { item = -1, texture = 0 },
					["shoes"] = { item = 29, texture = 1 },
					["tshirt"] = { item = 172, texture = 0 },
					["torso"] = { item = 91, texture = 0 },
					["accessory"] = { item = 96, texture = 0 },
					["watch"] = { item = -1, texture = 0 },
	...
	if user_id then
		if vRP.hasGroup(user_id,"Police") or vRP.hasGroup(user_id,"Paramedic") then
			...
			if model == "mp_m_freemode_01" or "mp_f_freemode_01" then
				TriggerEvent("fortal-character:Server:Skinshop:Save", source, preset[number][model])
			end
		end
	end
end)

		...
		if not IsPedInAnyVehicle(ped) then
			...
			for _,v in pairs(machines) do
				...
				if distance <= 0.6 then
					if serverAPI.startMachine(v[1], v[2]) then
						machinePosX = v[1]
						machinePosY = v[2]
						machinePosZ = v[3]
						...
						machineTimer = 10
						serverAPI.callPolice(machinePosX,machinePosY,machinePosZ)
						...
						serverAPI.removeC4(user_id,totalName,amount,bool,slot)
					end
				end
			end
		end

			...
			if GetPedInVehicleSeat(Vehicle, -1) == ped then
				...
				if vehRoll > 75.0 or vehRoll < -75.0 then
					if math.random(100) <= 50 and GetVehicleClass(Vehicle) ~= 8 then
						...
						if Tyre == 1 and GetTyreHealth(Vehicle, 0) == 1000.0 then
							SetVehicleTyreBurst(Vehicle, 0, true, 1000.0)
						elseif Tyre == 2 and GetTyreHealth(Vehicle, 1) == 1000.0 then
							SetVehicleTyreBurst(Vehicle, 1, true, 1000.0)
						elseif Tyre == 3 and GetTyreHealth(Vehicle, 4) == 1000.0 then
							SetVehicleTyreBurst(Vehicle, 4, true, 1000.0)
						elseif Tyre == 4 and GetTyreHealth(Vehicle, 5) == 1000.0 then

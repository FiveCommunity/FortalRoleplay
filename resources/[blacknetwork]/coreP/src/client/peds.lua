...
local pedList = {
	{ -- Concessionária
		distance = 30,
		coords = { -31.34,-1097.97,27.26,56.7 },
...
--[[ 	{ -- TowDriver
	...
	{ -- Black Market  ARMAS 2
		distance = 20,
		coords = { -1664.92,-1065.12,12.76,238.12 },
		model = { 0xF42EE883,"g_m_y_ballaeast_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Black Market  ARMAS 3
		distance = 20,
		coords = { -1653.0,-1062.77,12.15,141.74 },
		model = { 0xF42EE883,"g_m_y_ballaeast_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Black Market  ARMAS 4
		distance = 20,
		coords = { -1642.74,-1068.19,13.75,51.03 },
		model = { 0xF42EE883,"g_m_y_ballaeast_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Black Market
	...
	{ -- Black Market
	distance = 20,
	coords = { 253.17,6629.69,29.91,181.42 },
	model = { 0x4F46D607,"g_m_y_lost_01" },
	anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Black Market
	distance = 20,
	coords = { -561.81,286.34,82.18,260.79 },
	model = { 0x4F46D607,"g_m_y_lost_01" },
	anim = { "amb@prop_human_parking_meter@female@idle_a","idle_a_female" }
    },
	{ -- Black Market
	...
	{ -- Mansão Brad
	distance = 50,
	coords = { -3224.36,802.09,8.93,206.93 },
	...
	{ -- Police  
	distance = 100,
	coords = { 2530.57,-337.39,101.89,90.71 },
	model = { 0x15F8700D,"s_f_y_cop_01" },
	anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
    },
	{ -- Police  
	...
	{ -- Lenhador
		distance = 30,
		coords = { 2433.45,5013.46,46.99,0.5 },
		model = { 0x1536D95A,"a_m_o_ktown_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Minerador
	...
	{
		distance = 30,
		coords = vector4(-1048.06, -472.76, 36.65, 323.15),
		model = { `s_m_y_cop_01`, "s_m_y_cop_01" },
		anim = { dict = "anim@heists@heist_corona@single_team", name = "single_team_loop_boss" },
	}
}

exports("AddPed", function(data)
	table.insert(pedList,data)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADPEDLIST
-----------------------------------------------------------------------------------------------------------------------------------------
...
--     {
--         model = "404illegal_m2",
--         coords = vector3(120.72, -156.59, 54.86),
--         heading = 19.85
--     },
--     {
--         model = "BNTypeR2024",
--         coords = vector3(126.33, -158.54, 54.86),
--         heading = 19.85
--     },
--     {
--         model = "ikx3gt3rs23",
--         coords = vector3(132.04, -160.83, 54.86),
--         heading = 22.68
--     },
--     {
--         model = "lfa2011",
--         coords = vector3(137.75, -162.84, 54.86),
--         heading = 19.85
--     },
--     {
--         model = "glsmansory850",
--         coords = vector3(143.36, -164.92, 54.86),
--         heading = 19.85
--     }
-- }
...
--     for i, data in ipairs(vehicleSpawns) do
...
--             timeout = timeout + 1
--             if timeout > 100 then
--                 print("[ERRO] Modelo " .. data.model .. " não carregou.")
--                 break
--             end
--         end

--         if HasModelLoaded(model) then
--             local vehicle = CreateVehicle(model, data.coords.x, data.coords.y, data.coords.z, data.heading, false, false)

--             FreezeEntityPosition(vehicle, true)
--             SetEntityInvincible(vehicle, true)
--             SetVehicleDoorsLocked(vehicle, 2) -- 2 = trancado
--             SetVehicleUndriveable(vehicle, true)
--             SetVehicleNumberPlateText(vehicle, "EXPOSICAO")

--             -- Impede que seja salvo automaticamente ou sumido
--             SetEntityAsMissionEntity(vehicle, true, true)
--             SetVehicleOnGroundProperly(vehicle)

--             spawnedVehicles[#spawnedVehicles + 1] = vehicle

--             -- Pequena espera entre os spawns
--             Wait(500)
--         end
--     end
-- end)

...
Loots = {
	{
        ["41"] = { item = "WEAPON_PISTOL_AMMO", amount = math.random(4,15) },
        ["42"] = { item = "lockpick2", amount = 1 },
        ["43"] = { item = "meth", amount = math.random(1,5) },
        ["44"] = { item = "dollarsroll", amount = math.random(1000,5000) },
    },{
        ["41"] = { item = "metalcan", amount = math.random(5,30) },
        ["42"] = { item = "copper", amount = math.random(5,30) },
        ["43"] = { item = "lockpick", amount = 1 },
        ["44"] = { item = "dollarsroll", amount = math.random(1000,5000) },
    },{
        ["41"] = { item = "spray05", amount = math.random(1,3) },
        ["42"] = { item = "lean", amount = math.random(1,5) },
        ["43"] = { item = "floppy", amount = 3 },
    },{
        ["41"] = { item = "WEAPON_PISTOL_AMMO", amount = math.random(4,15) },
        ["42"] = { item = "card01", amount = 1 },
        ["43"] = { item = "meth", amount = math.random(1,5) },
        ["44"] = { item = "dollarsroll", amount = math.random(1000,5000) },
    },{
        ["41"] = { item = "WEAPON_PISTOL_AMMO", amount = math.random(4,15) },
        ["42"] = { item = "c4", amount = 1 },
        ["43"] = { item = "tiner", amount = 1 },
        ["44"] = { item = "dollarsroll", amount = math.random(1000,5000) },
    },{
        ["41"] = { item = "metalcan", amount = math.random(5,30) },
        ["42"] = { item = "copper", amount = math.random(5,30) },
        ["43"] = { item = "card02", amount = 1 },
        ["44"] = { item = "dollarsroll", amount = math.random(1000,5000) },
    },{
        ["41"] = { item = "metalcan", amount = math.random(5,30) },
        ["42"] = { item = "copper", amount = math.random(5,30) },

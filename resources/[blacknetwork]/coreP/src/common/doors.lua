...
-----------------------------------------------------------------------------------------------------------------------------------------
GlobalState["Doors"] = {
	[1] = { x = -959.97, y = -2053.02, z = 9.4, hash = -1291439697, lock = true, text = true, distance = 20, press = 5, perm = "Police" }, 
	[2] = { x = -953.14, y = -2053.67, z = 9.4, hash = -806761221, lock = true, text = true, distance = 20, press = 5, perm = "Police" },  
	[3] = { x = -916.11, y = -2038.4, z = 9.4, hash = -1316777937, lock = true, text = true, distance = 20, press = 5, perm = "Police", other = 4 }, 
	[4] = { x = -915.15, y = -2037.37, z = 9.4, hash = -1316777937, lock = true, text = true, distance = 10, press = 2, perm = "Police", other = 3 }, 
	[5] = { x = -937.91, y = -2037.62, z = 26.54, hash = -875057463, lock = true, text = true, distance = 10, press = 2, perm = "Police" },   
	[6] = { x = -939.59, y = -2045.92, z = 6.1, hash = -806761221, lock = true, text = true, distance = 10, press = 2, perm = "Police" }, 
	[7] = { x = -954.4, y = -2043.99, z = 9.5, hash = 1307986194, lock = true, text = true, distance = 10, press = 2, perm = "Police" }, 
...
--	[96] = { x = -953.27, y = -2052.06, z = 9.4, hash = -1291439697, lock = true, text = true, distance = 20, press = 5, perm = "Police" },    
...
-- BALAS
   ...
   [108] = { x = -955.04, y = -2057.98, z = 9.4, hash = 1307986194, lock = true, text = true, distance = 10, press = 2, perm = "Police", other = 109 },
   [109] = { x = -954.27, y = -2058.75, z = 9.4, hash = 1307986194, lock = true, text = true, distance = 10, press = 2, perm = "Police", other = 108 },
...
--    [113] = { x = 551.98, y = -3117.96, z = 18.75, hash = 1388116908, lock = true, text = true, distance = 20, press = 2, perm = "Mafia", other = 108 },
   [114] = { x = -952.03, y = -2049.08, z = 6.1, hash = -806761221, lock = true, text = true, distance = 20, press = 2, perm = "Police", other = 108 },
  
 
   [115] = { x = -1197.13, y = -1732.16, z = 4.6, hash = 1368401976, lock = true, text = true, distance = 20, press = 2, perm = "FPraia", other = 108 },  -- FPraia
   [116] = { x = 1265.24, y = -1088.86, z = 46.86, hash = 1368401976, lock = true, text = true, distance = 20, press = 2, perm = "FCrips", other = 108 },  -- FCrips
   ...
   [120] = { x = 442.57, y = -999.29, z = 30.72, hash = -1547307588, lock = true, text = true, distance = 10, press = 2, perm = "Police", other = 121 },
   [121] = { x = 441.31, y = -999.29, z = 30.72, hash = -1547307588, lock = true, text = true, distance = 10, press = 2, perm = "Police", other = 120 }, 
   [122] = { x = 440.96, y = -985.66, z = 30.68, hash = -96679321, lock = true, text = true, distance = 10, press = 2, perm = "Police" },   
} 

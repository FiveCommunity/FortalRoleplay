...
-- CHECKPOLICE
-----------------------------------------------------------------------------------------------------------------------------------------
function src.checkPolice(vehPlate)
...
-- WITHDRAWMONEY
-----------------------------------------------------------------------------------------------------------------------------------------
function src.withdrawMoney(vehPlate,vehNet)
	local source = source
	...
	if user_id then
		...
		if not stockadePlates[vehPlate] then
			...
			if stockadePlates[vehPlate] > 0 then
				...
				TriggerClientEvent("vrp_stockade:FreezePlayer", source, true)
				...
				TriggerClientEvent("vrp_stockade:FreezePlayer", source, false)

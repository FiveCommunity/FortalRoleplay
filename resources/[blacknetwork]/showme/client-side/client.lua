...
RegisterNetEvent("showme:NPC")
AddEventHandler("showme:NPC", function(message,npc)
    showMePC[npc] = { message,10,nil }
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- SHOWME:REMOVEME
-----------------------------------------------------------------------------------------------------------------------------------------
...
Citizen.CreateThread(function()
    while true do 
        ...
        for k,v in pairs(showMePC) do
            local targetPed = k
            if DoesEntityExist(targetPed) then
                local coordsMe = GetEntityCoords(targetPed)
                local distance = #(coords - coordsMe)

...
local bennysLocations = {
	["mechanic01"] = {
		pos = vec3(-201.82,-1318.91,31.29), 
	 	permission = "Bennys",
		heading = 348.67
	},
	["mechanic02"] = {
		pos = vec3(732.02,-1088.66,22.16),
	 	permission = "Raijin",
		heading = 269.3
	},
	["mechanic03"] = {
		pos = vec3(830.26,-819.21,26.34),
	 	permission = "Raijin",
		heading = 269.3
	},
	["mechanic04"] = {
		pos = vec3(830.41,-805.55,26.34),
	 	permission = "Raijin",
		heading = 269.3
	},
	["mechanic08"] = {
		pos = vec3( 875.81,-2125.41,29.55),
		 permission = "Raijin",
		heading = 354.34
	},
	["mechanic09"] = {
		pos = vec3( 886.99,-2126.3,29.55),
		 permission = "Raijin",
		heading = 357.17
	},
	["mechanic10"] = {
		pos = vec3( 897.96,-2127.17,29.55),
		 permission = "Raijin",
		heading = 0.0
	},
	["mechanic11"] = {
		pos = vec3( 909.3,-2128.35,29.55),
		permission = "Raijin",
		heading = 354.34
	},
	["mechanic12"] = {
		pos = vec3(-220.81,-1319.1,31.29),  
	 	permission = "Bennys",
		heading = 14.18
	},
	["mechanic13"] = {
		pos = vec3(-239.78,-1336.6,31.29),  
	 	permission = "Bennys",
		heading = 357.17
	},
	["mechanic14"] = {
		pos = vec3(862.08,-2124.71,30.53),  
	 	permission = "Raijin",
		heading = 354.34
	},
	["mechanic15"] = {
		pos = vec3(127.1,-3037.87,6.57),  
	 	permission = "Bennys",
		heading = 87.88
	},
	["mechanic16"] = {
		pos = vec3(127.05,-3031.27,6.57),  
	 	permission = "Bennys",
		heading = 87.88
	},
	["mechanic17"] = {
		pos = vec3(142.01,-3019.92,6.57),  
	 	permission = "Bennys",
		heading = 0.0
	},
	["mechanic18"] = {
		pos = vec3(142.58,-2996.24,7.03),  
	 	permission = "Bennys",
		heading = 22.68
	}
} 
...
AddEventHandler("lscustoms:applyMods",function(vehNet,vehCustom)
		...
		if DoesEntityExist(veh) then
			...
			local customFunctions = {
				...
				["extracolors"] = function(extracolors)
					SetVehicleExtraColours(veh, tonumber(extracolors[1]), tonumber(extracolors[2]))
				end,
				...
				["mods"] = function(mods)
					for i,t in pairs(mods) do 
						...
						elseif tonumber(i) == 23 or tonumber(i) == 24 then
							SetVehicleMod(veh,tonumber(i),tonumber(mods[i]),tonumber(custom["var"][i]))
						else
...
RegisterNetEvent("openBennysManual")
AddEventHandler("openBennysManual", function()
    local ped = PlayerPedId()
    if IsPedInAnyVehicle(ped) then
        local vehicle = GetVehiclePedIsUsing(ped)
        if GetPedInVehicleSeat(vehicle, -1) == ped then
            ...
            TriggerEvent("Notify", "aviso", "Você precisa estar no banco do motorista.")
        end
    else
        TriggerEvent("Notify", "aviso", "Você precisa estar em um veículo.")
    end
end)

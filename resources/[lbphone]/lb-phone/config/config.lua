...
Config.Item.Inventory = "other-inventory" --[[
...
Config.Companies.Services = {
    ...
    }, 
    {
        job = "Direito",
        name = "Advogado", 
        icon = "https://cdn.discordapp.com/attachments/1001927093174669343/1370082772663664710/lawyer.png?ex=681e3483&is=681ce303&hm=cf06c738ac5768216cd269c499a9f93ef30681f53c55dfd77e74abc510b4d1ca&",
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"boss", "worker"}, -- ranks that can manage the company
        location = {

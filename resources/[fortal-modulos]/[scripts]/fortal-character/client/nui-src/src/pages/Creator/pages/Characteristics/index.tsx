...
import { usePartial, type Characteristics } from "./stores/usePartial";
...
export default function Characteristics() {
  ...
  useEffect(() => {
    Post.create<Record<string, Characteristics>>(
      "Creator:GetData",
  ...
  useEffect(() => {
    Post.create("Creator:UpdatePedPreview", {
      section: "characteristics",
      data,
    });
  }, [data]);
  ...
  return (
    <div className="flex size-full items-center justify-between overflow-visible">
      <div className="flex w-[20.125rem] flex-col items-center overflow-visible">
        ...
        <Footer canReturn page="2" canClick={save.current} />
      </div>
    </div>
  );
}

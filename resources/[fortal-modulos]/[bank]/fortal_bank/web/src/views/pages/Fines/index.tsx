        ...
        <div className="w-full h-[6rem] flex items-center justify-between p-6">
          <div className="flex items-center justify-center gap-4">
            ...
            >
              ...
              />
              <path
                d="M10.7415 5.71321C10.8674 5.49673 11.0502 5.31664 11.2712 5.19133C11.4922 5.06603 11.7434 5 11.9992 5C12.255 5 12.5062 5.06603 12.7272 5.19133C12.9482 5.31664 13.131 5.49673 13.2569 5.71321L19.8045 16.8657C20.3614 17.8146 19.6621 19 18.5452 19H5.45475C4.33788 19 3.63863 17.8146 4.19547 16.8657L10.7415 5.71321ZM11.1991 10.4439V11.9996C11.1991 12.2059 11.2834 12.4037 11.4335 12.5496C11.5835 12.6955 11.787 12.7774 11.9992 12.7774C12.2114 12.7774 12.4149 12.6955 12.5649 12.5496C12.715 12.4037 12.7993 12.2059 12.7993 11.9996V10.4439C12.7993 10.2376 12.715 10.0398 12.5649 9.89393C12.4149 9.74806 12.2114 9.66611 11.9992 9.66611C11.787 9.66611 11.5835 9.74806 11.4335 9.89393C11.2834 10.0398 11.1991 10.2376 11.1991 10.4439ZM11.9992 13.9441C11.6809 13.9441 11.3757 14.0671 11.1506 14.2859C10.9256 14.5047 10.7991 14.8014 10.7991 15.1109C10.7991 15.4203 10.9256 15.7171 11.1506 15.9359C11.3757 16.1547 11.6809 16.2776 11.9992 16.2776C12.3175 16.2776 12.6227 16.1547 12.8478 15.9359C13.0728 15.7171 13.1993 15.4203 13.1993 15.1109C13.1993 14.8014 13.0728 14.5047 12.8478 14.2859C12.6227 14.0671 12.3175 13.9441 11.9992 13.9441Z"
                fill="#3C8EDC"
              />
            </svg>
            <div className="flex items-center justify-center gap-2">
              <h1 className="text-white text-base font-bold">Multas</h1>
            ...
            >
              <div className="w-full flex items-center justify-between mb-4">
                ...
                >
                  ...
                  />
                  <path
                    d="M26.4269 19.917C26.5843 19.6387 26.8128 19.4071 27.089 19.246C27.3652 19.0849 27.6792 19 27.999 19C28.3188 19 28.6328 19.0849 28.909 19.246C29.1852 19.4071 29.4137 19.6387 29.5711 19.917L37.7557 34.2558C38.4517 35.4759 37.5777 37 36.1816 37H19.8184C18.4223 37 17.5483 35.4759 18.2443 34.2558L26.4269 19.917ZM26.9989 25.9993V27.9995C26.9989 28.2647 27.1043 28.5191 27.2918 28.7066C27.4794 28.8942 27.7338 28.9995 27.999 28.9995C28.2642 28.9995 28.5186 28.8942 28.7062 28.7066C28.8937 28.5191 28.9991 28.2647 28.9991 27.9995V25.9993C28.9991 25.7341 28.8937 25.4797 28.7062 25.2922C28.5186 25.1046 28.2642 24.9993 27.999 24.9993C27.7338 24.9993 27.4794 25.1046 27.2918 25.2922C27.1043 25.4797 26.9989 25.7341 26.9989 25.9993ZM27.999 30.4996C27.6011 30.4996 27.2196 30.6577 26.9383 30.939C26.6569 31.2203 26.4989 31.6019 26.4989 31.9997C26.4989 32.3975 26.6569 32.7791 26.9383 33.0604C27.2196 33.3417 27.6011 33.4998 27.999 33.4998C28.3969 33.4998 28.7784 33.3417 29.0597 33.0604C29.3411 32.7791 29.4991 32.3975 29.4991 31.9997C29.4991 31.6019 29.3411 31.2203 29.0597 30.939C28.7784 30.6577 28.3969 30.4996 27.999 30.4996Z"
                    fill="#B35B5D"
                  />
                </svg>
              </div>
              ...
              <div className="w-full text-white/60 text-sm font-normal mt-3">
                Recebeu 11 novas multas nas últimas 4 semanas.
              </div>
            </div>
          </div>

          <div className="w-full flex items-center justify-center">
            <FinesHistory className="w-full" />
          </div>
        </div>
      </motion.div>
    </>

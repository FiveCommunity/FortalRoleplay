import { useOptions, useSelectUsers } from "@/stores/useLocked";

import { Icon } from "../../Navigation";
import { useNavigate } from "react-router-dom";
import { useState } from "react";

export function LockedInfractions() {
              ...
              .map((data, index) => {
                ...
                return (
                  <button
                    ...
                    } relative flex h-[2.3vw] w-full flex-none items-center gap-[.5vw] rounded-[.3vw] border border-[#FFFFFF08] bg-section px-[.4vw] hover:border-[#79FF921A]`}
                  >
                                         <div className="bg-tag flex h-[1.4vw] w-fit items-center rounded-[.2vw] border border-[#FFFFFF0D] px-[.5vw]">
                       <h1 className="text-[.8vw] font-[700] capitalize text-white whitespace-nowrap">
                         Art. {data.art}
                       </h1>
                     </div>
                                         <h1 
                       className="text-[.8vw] font-[500] text-[#FFFFFFCC] truncate"

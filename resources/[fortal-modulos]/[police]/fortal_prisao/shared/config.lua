...
Config.Debug = false
Config.PrisonName = "Penitenciária Estadual"
...
Config.PrisonCoords = {
    -- Prisão Normal
    internal = { 1679.94, 2513.07, 45.56 },
    external = { 1896.15, 2604.44, 45.75 },
    leaver = { 1834.09, 2594.34, 46.02 },
    
    -- Segurança Máxima (Nova cadeia)
    maxima = {
        internal = { 3896.47,26.38,23.89 },
        external = { 2560.53,364.79,108.61 },
        leaver = { 3888.04,-28.61,6.71 }
    }
}

-- Locais de Serviços (Pontos de trabalho)
...
-- Locais de Serviços Segurança Máxima
Config.MaximaServiceLocations = {
    { 4025.2,19.26,21.57,96.38 },
    { 4020.24,22.57,21.92,53.86 },
    { 4011.17,27.12,21.48,31.19 },
    { 4009.93,31.26,21.26,14.18 },
    { 4008.39,27.59,21.89,99.22 },
    { 4002.69,27.37,20.89,90.71 },
    { 4010.29,19.18,21.9,243.78 }
}
...
-- Itens que podem ser encontrados durante os serviços
Config.PrisonItems = {
...
Config.Timers = {
    serviceDuration = 10000, -- 10 segundos para completar um serviço
    cooldown = 3000, -- 3 segundos de cooldown entre serviços
    deathTimeout = 60000, -- 60 segundos para reviver após morte
    serviceReduction = 4 -- Quantidade de serviços reduzidos por cada tarefa completada (1 = reduz 1 serviço por tarefa)
}

-- Configurações de Animações e Props por Tipo de Prisão
Config.PrisonAnimations = {
    ["normal"] = {
...
-- Configurações de Polícia
Config.Police = {
    minOfficers = 5, -- Mínimo de policiais online para usar o sistema
    notificationDistance = 100.0 -- Distância para notificar policiais sobre fugas
}
...
-- Configurações de Áreas de Prisão
Config.PrisonAreas = {
    ["normal"] = {
        points = {
    ...
    ["maxima"] = {
        points = {
            vector2(3772.48,84.31),
            vector2(3767.75,-56.54),
            vector2(4140.64,-61.29),
            vector2(4125.1,120.95)
        }
    }
}

-- Configurações de Cutscene de Fotografia Policial
Config.Cutscene = {
    enabled = true,
    duration = 15000, -- 15 segundos de duração total da cutscene
    
    -- Coordenadas da câmera e do jogador durante a cutscene
    camera = {
        pos = { 1679.94, 2513.07, 45.56 }, -- Posição da câmera
        rot = { 0.0, 0.0, 0.0 }, -- Rotação da câmera
        fov = 50.0 -- Campo de visão
    },
    
    player = {
        pos = { 1679.94, 2513.07, 45.56 }, -- Posição do jogador
        heading = 0.0 -- Direção que o jogador deve olhar
    },
    
    -- Configurações da placa com nome
    nameplate = {
        enabled = true,
        text = "SUSPEITO", -- Texto padrão da placa
        font = 4,
        scale = 0.8,
        color = {255, 255, 255, 255},
        position = {0.5, 0.3} -- Posição na tela (x, y) - 0.5 = centro horizontal, 0.3 = 30% da altura
    },

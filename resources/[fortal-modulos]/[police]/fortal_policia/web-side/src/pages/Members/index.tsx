        ...
        <div className="h-[27.3vw] w-full rounded-[.3vw] border border-[#FFFFFF08] bg-section">
          ...
          <div className="flex h-[calc(100%-2.5vw)] w-full flex-col overflow-auto">
            ...
            {members
              ...
              .map((data, i) => (
                <Member data={data} i={i} />
              ))}
          </div>
        </div>
        <div className="mt-[.5vw] flex items-center justify-between">
          <div className="flex h-[2.5vw] w-[calc(100%-5vw)] items-center gap-[.5vw] rounded-[.4vw] border border-[#FFFFFF08] bg-section px-[.8vw]">
            <Icon.search className="w-[.8vw] text-[#FFFFFF80]" />
            <input
              className="h-full w-[calc(100%-5vw)] bg-transparent text-[.8vw] text-white placeholder:text-[#FFFFFF80]"
              type="text"
              value={search}
